...
const Liquid = ({ animationSpeed = 172 }) => {
  ...
  function drawVisualisation() {
    ...
    for (let i = 0; i < bufferLength; i++) {
      ...
      gradient.addColorStop(0, "#a8ea7c");
      gradient.addColorStop(1, "#c9d3c2");
       ...
       active:brightness-90 active:translate-y-1   hover:shadow-green-300 shadow-green-300 active:shadow-none  "
        ...
        <div className="flex sm:flex-col items-center justify-center">
          <div className="flex sm:flex-row mt-3 sm:mt-4 flex-col mb-3 ">
            ...
            <button
              type="button"
              className="m-1 inline-block px-3 border-2 border-white py-3 mr-3 font-bold text-center text-white uppercase align-middle transition-all rounded-lg cursor-pointer bg-gradient-to-tl from-stone-600 to-lime-500 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:scale-110 hover:rotate-2 hover:bg-amber-500  hover:shadow-lg active:opacity-85"
              onClick={() => openLiquid()}
            >
              Liquid DNB
            </button>
